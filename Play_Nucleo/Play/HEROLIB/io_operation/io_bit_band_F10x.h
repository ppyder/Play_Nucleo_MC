...
#ifndef _IO_BITBAND_F10X_H
#define _IO_BITBAND_F10X_H
...
/**
  ...
  */
#define ODR_Addr_Offset	0x0C

/**
  * @brief IDR寄存器相对于基地址的偏移量
  */
#define IDR_Addr_Offset	0x08
